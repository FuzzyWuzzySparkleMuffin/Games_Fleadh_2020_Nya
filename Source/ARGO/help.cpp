...
Help::Help()
{
	...
	rect1 = { 300, 350, 1200 / 2, 800 / 2 };
	rect2 = { 1100, 350, 1200 / 2, 800 / 2 };
...
void Help::render(SDL_Renderer* t_renderer)
{
	...
	SDL_RenderCopy(t_renderer, Texture1, NULL, &rect1);
	SDL_RenderCopy(t_renderer, Texture2, NULL, &rect2);
...
void Help::loadSprites(SDL_Renderer* renderer)
{
	if (m_backgroundTexture == NULL)
	{
		...
		loadedSurface = SDL_LoadBMP("ASSETS/IMAGES/ControllerSprite.bmp");
		Texture1 = SDL_CreateTextureFromSurface(renderer, loadedSurface);
		surface2 = SDL_LoadBMP("ASSETS/IMAGES/AButton.bmp");
