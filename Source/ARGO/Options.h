...
private:
	...
	SDL_Rect cactusRect = { 700, 475, 200,200 };
	SDL_Rect stateRect = { 700, 875, 200,200 };
	SDL_Rect levelCompleteRect = { 200, 75, 200,200 };

	SDL_Surface* cactusSurface;
	SDL_Surface* stateSurface;
