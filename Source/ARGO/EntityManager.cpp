		...
		if (tempE.getComponentString() == "move")
		{
			if (tempE.getComponent<PositionComponent>().getPosition() != Vector2(7200, 480))
			{
				for (auto& f : entities)
				{
					...
					if (tempF.getComponentString() == "player")
					{
						int tempEnumX = tempF.getComponent<PositionComponent>().getPreviousPosition().X();
						int tempEnumY = tempF.getComponent<PositionComponent>().getPreviousPosition().Y();
						tempEnumX = tempEnumX % 60;
						tempEnumY = tempEnumY % 60;
						Vector2 playerPos=tempF.getComponent<PositionComponent>().getPosition();
						if (m_colSys.collides(tempE.getComponent<PositionComponent>().getPosition(),
							tempE.getComponent<BodyComponent>().getSize(),
							tempF.getComponent<PositionComponent>().getPosition(),
							tempF.getComponent<BodyComponent>().getSize()))
						{
							...
							if (xVal + 180 > tempE.getComponent<PositionComponent>().getPosition().x&& xVal < tempE.getComponent<PositionComponent>().getPosition().x + 180 &&
								yVal + 180 > tempE.getComponent<PositionComponent>().getPosition().y&& yVal < tempE.getComponent<PositionComponent>().getPosition().y + tempE.getComponent<PositionComponent>().getPosition().x)
							{
